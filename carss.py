...
Original file is located at
    https://colab.research.google.com/drive/15BvZuMX8j0H3-zqZciseObUkghR_cbW6
"""
...
if uploaded_file is not None:
    ...
    try:
        ...
        st.info("✅ Loaded default dataset from `/content/car.csv`")
...
if df is not None:
    ...
    st.markdown("❤️ **Made by Arpita❤️**")
